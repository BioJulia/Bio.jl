...
const char_to_op = [
  ...
  OP_INVALID, OP_INVALID, OP_INVALID, OP_CICAR_D, OP_INVALID,
  ...
  OP_CICAR_I, OP_INVALID, OP_INVALID, OP_INVALID, OP_CIGAR_M,
  OP_CICAR_N, OP_INVALID, OP_CIGAR_P, OP_INVALID, OP_INVALID,
