...
macro dnapat_str(pat)
    :($(Seq.RE.Regex{DNANucleotide}(pat, :pcre)))
end

macro rnapat_str(pat)
    :($(Seq.RE.Regex{RNANucleotide}(pat, :pcre)))
end

macro aapat_str(pat)
    :($(Seq.RE.Regex{AminoAcid}(pat, :pcre)))
end

macro prosite_str(pat)
    :($(Seq.RE.Regex{AminoAcid}(pat, :prosite)))
end
